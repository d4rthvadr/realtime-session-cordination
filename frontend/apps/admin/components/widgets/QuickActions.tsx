...
export default function QuickActions({ actions }: QuickActionsProps) {
  const getButtonVariant = (variant: QuickAction["variant"] = "default") => {
    switch (variant) {
      case "danger":
...
export function MuteIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function MoreIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
